      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <motion.div
            ...
            className="lg:col-span-5 text-left p-8 rounded-3xl bg-black/90 border-2 border-crimson-500/50 backdrop-blur-xl shadow-2xl"
          >
            <span className="font-mono text-xs uppercase tracking-[0.3em] text-yellow-300 font-bold px-4 py-2 bg-red-950/90 border border-yellow-400/50 rounded-full inline-block mb-4 shadow-md">
              REALM 02 • THE AWAKENING
            </span>
            ...
            <div className="font-display font-black text-7xl sm:text-9xl text-white tracking-tight leading-none my-4 drop-shadow-[0_4px_16px_rgba(0,0,0,1)]">
              # <span className="text-crimson-bright text-glow-crimson">36</span>
              <span className="block text-4xl sm:text-6xl text-yellow-300">HOURS</span>
            </div>

            <p className="font-mono text-sm text-yellow-400 font-bold tracking-widest uppercase">
          ...
          <motion.div
            ...
            className="lg:col-span-7 space-y-6 text-left p-8 rounded-3xl bg-black/90 border-2 border-yellow-400/50 backdrop-blur-xl shadow-2xl"
          >
            <h2 className="font-display text-4xl sm:text-6xl font-black text-white tracking-tight leading-tight drop-shadow-md">
              ENTER THE <span className="text-crimson-bright text-glow-crimson">BATTLEFIELD</span> OF INNOVATION
            </h2>

            <p className="text-white text-base sm:text-xl font-medium leading-relaxed drop-shadow-sm">
              CodeSlayer 2.0 is not a standard hackathon. Organised by <strong className="text-yellow-300 font-bold">DevSphereIndia</strong> in association with <strong className="text-yellow-300 font-bold">NIT Delhi</strong>, it is a high-stakes arena where 500+ top developers compete across 6 breathing style domains.
            </p>
