...
export const OrganiserLogos = () => {
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-6 py-4 px-6 rounded-2xl bg-[#0B0B0E]/90 border border-crimson-500/30 backdrop-blur-md shadow-xl my-4">
      ...
      >
        ...
        <div className="text-left">
          ...
          <span className="font-display font-bold text-sm text-gray-200 group-hover:text-white transition-colors">
            NIT Delhi
          </span>
        </div>
      </a>
